...
class Calendar:
    """This class defines a Calendar object."""
    def __init__(self):
    ...
    def insert(self, lmsuserid: str, bookid: str, title: str, author: str):
        """
        Inserts event details such as summary, location, description, start time
        of the event, end time of the event, attendees and reminders into the Google
        Calendar API. 
        """
        today = datetime.now()
