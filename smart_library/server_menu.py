...
class ServerMenu:
    """This class contains information regarding the server menu that is served to users of the system."""
    ...
    def search_book(self):
        """Search for a book on the server menu."""
    ...
    def borrow_book(self):
        """Borrow a book on the server menu."""
    ...
    def return_book(self):
        """Return a book on the server menu."""
